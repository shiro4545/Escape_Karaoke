...
public class UIConroller : MonoBehaviour
{
    ...
    // //ゲームスタートオブジェクト
    // public StartResetSystem StartReset;
    //
    ...
    //         GameFooter.GetComponent<RectTransform>().anchoredPosition = new Vector2(-407, -100);
    //         //メニューパネル
    //         MenuPanel.GetComponent<RectTransform>().anchoredPosition = new Vector2(0, 0);
    //         MenuPanel.GetComponent<RectTransform>().sizeDelta = new Vector2(0, 1230);
    //         //ヒントパネル
    //         HintPanel.GetComponent<RectTransform>().anchoredPosition = new Vector2(0, 0);
    //         HintPanel.GetComponent<RectTransform>().sizeDelta = new Vector2(0, 1230);
    //         //アイテムパネル
    ...
    //             GameFooter.GetComponent<RectTransform>().anchoredPosition = new Vector2(-407, -90);
    //         }
    //         else if (Screen.width <= 1300)//iPhone10以上
    //         {
    //             GameHeader.GetComponent<RectTransform>().anchoredPosition = new Vector2(0, -295);
    //             GameFooter.GetComponent<RectTransform>().anchoredPosition = new Vector2(-407, -15);
    //         }
    //         else //iPad
    //         {
    //             //タイトルパネル
    ...
    //             GameFooter.GetComponent<RectTransform>().anchoredPosition = new Vector2(-407, -126);
    //             //メニューパネル
    //             MenuPanel.GetComponent<RectTransform>().anchoredPosition = new Vector2(0, 0);
    ...
    //             Hint1.fontSize = 44;
    //             Hint1.GetComponent<RectTransform>().anchoredPosition = new Vector2(0, 43);
    //             Hint2.fontSize = 44;
    //             Hint2.GetComponent<RectTransform>().anchoredPosition = new Vector2(0, -100);
    //             Hint2_ads.GetComponent<RectTransform>().anchoredPosition = new Vector2(0, -164);
    //             BtnHint_Hint2.GetComponent<RectTransform>().anchoredPosition = new Vector2(0, -99);
    //             BtnHint_Hint2.GetComponent<RectTransform>().sizeDelta = new Vector2(130, 25);
    //             BtnHint_Back.GetComponent<RectTransform>().anchoredPosition = new Vector2(0, -390);
    //             //アイテムパネル
    //             ItemPanel.GetComponent<RectTransform>().anchoredPosition = new Vector2(0, 18);
