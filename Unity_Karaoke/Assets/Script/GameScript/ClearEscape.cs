...
public class ClearEscape : MonoBehaviour
{
  public GameObject ClearPanel;
  public GameObject ClearImage;
  public GameObject ToTitle;
  public GameObject Unchi1;
  public GameObject Unchi2;
  public GameObject Unchi3;
  ...
  public void escape(){
    ...
    DOTween.To(() => camera.fieldOfView, fov => camera.fieldOfView = fov, 20, 10);
    camera.transform.DOMove(new Vector3(1,0,0), 10).SetRelative(true);
